...
其中谈到 JS 中冻结一个对象几种由浅入深的实践。想想也暗合国学大师所谓的三重境界。 具体分享内容，还没有上车的同学们可以点击这里，参看实录。欢迎一起讨论。来源，[点击这里也可以查看](https://gitbook.cn/books/5919ab35c370474b2fa23006/index.html)。

这篇文章由浅入深讨论 JS 中对象的一些锁定特性。但都是一些基础语法的实现，相信即便是前端小白也可以大体领会。不过需要读者预先了解 JS 中对象的特性，尤其是对象自身属性的描述符：configurable、writable...

另外，如果您对 JS 中对象操作、不可变数据、函数式编程感兴趣，同样推荐我的其他一些来源：
