...
title: 第118期
date: '2022-02-17'
tags: ['资讯', 'observer', 'js', 'css']
draft: false
summary: 浏览器的 5 种 Observer，你用过几种？;小技巧 | 渐变消失遮罩的多种实现方式
---
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b0a7e768453e4bb99365e614a98d8b3f~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5f7c3f41e1924c62942a741bd7d4baa5~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/647a660a3f0f40ea90cff9b2a6ea8398~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a7e836594b754b2e8d262c3fee602ec9~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

可以看到在三次变化的时候都监听到了并打印了一些信息：

第一次改变的是 attributes，属性是 style：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d2b3290ac244c319a307dfe74d9aad8~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

第二次改变的是 childList，添加了一个节点：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/35be2e97254f41d9b04e8e7544a1c12b~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

第三次也是改变的 childList，删除了一个节点：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e22cf73b71342069320a7067fc7d9ef~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3712761d69f142e6bbe580db5a712977~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

大小变化被监听到了，看下打印的信息：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c64db90b225e4350b777f8ec57032043~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c5d336a321b147f2ab655e1c6857d55d~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4aacfb0969534307b2718f27e3b52472~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

图片加载：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0795f5a92e2947caa1d2c8939912dab3~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d7d6bcc99daa4c588ccf9005fbfbb453~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

浏览器还会在一些情况下对网页行为做一些干预（intervention），比如会把占用 cpu 太多的广告的 iframe 删掉：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f7bb6903a6f846908cde63064336ceab~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

会在网络比较慢的时候把图片替换为占位图片，点击才会加载：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9fa5be3e31ff4846ad8b90b1a61e6ee7~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)

这些干预都是浏览器做的，会在控制台打印一个报告：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7d5f7d6e298a49e8af99792f696ae803~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp?)
